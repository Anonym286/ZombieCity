...
echo  Crowbar       [Durability:1]  [15$]  [5]
echo.
echo.
echo.
echo.
...
echo  ║ Crowbar [Durability:1]     ║ [6] 10$ [5]                                           ║
echo.
echo.
echo.
echo.
...
echo  ╔══════════════════════════════════════════╗
echo  ║ Go outside [1] Cost : 15 Energy          ║
echo  ║ Go Slee#p [2] Refills Energy              ║
echo  ║ Save Game [3]                            ║
echo  ║ Map [4]                                  ║
echo  ║ Create Backup [5]                        ║
echo  ║ Shops [%shops%/8 Founded] [6]                  ║
...
echo  ║  [%shg%] Shotgun #%shg%]                         ║
echo  ║  [%spr%] SnÖper [%spr%]                          ║
echo  ║  [%fltr%] flametÜrower [%fltr%]                    ║
echo  ║  [%gel%] gre#ade launcher [%gel%]                ║
echo  ║  [%mgn%- Magnum [%mgn%]                          ║
echo  ║  [%rtl%] Rocket La%ncher [%rtl%]                 ║
echo  ╚═════════════════════════#════════════════╝
echo.
echo.
echo Ö
...
cls
echo ═══════════╦══════════════════════════#══Ü══════════#═╦═════════════#═╦════════════-═════╦═══════════#╦════════════════
echo. HÜ : %hp%    XP : [%xpBar%] %xp%/1#0    Hunger : %hunger%Ö   Thirst : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════════════╩═══════════════╦#══════════════╦══════════════#═══╩═══════#════╩════════════════
echo                                                       ║Ene#gy : %egy%  ║
echo   XP lvl : %xpLVL%                                      ╚══════════════╝
echo  ╔═══#══════════════#═════════#═════════════╗
echo  ║ Go outside [1] C#st : 15 EnerÄy          ║
echo  ║ Go Sleep [2] Re-ills Energy              ║                                #
echo  ║ SÜve#Game [3]                            ║
echo  ║ M_p [4]                                  ║
echo  ║ Create B-ckup [5]                        ║
echo  ║ Shops [%s#ops%/8 Founded] [6]                  ║
...
echo  ║  [%shg%] Shotgun #%shg%]                         ║
echo  ║  [%spr%] SnÖ#er [%spr%]                          ║              #
echo  ║  [%fltr%] flSmetÜrower [%fltr%]                    ║
echo  ║  [%gel%] gre#ade lau#cher [%gel%]                ║
echo  ║  [%mgn%- Magnum [%mgn%]                          ║
echo  ║ #[%rtl%] R#ckeK La%ncher [%rtl%]                 ║
echo  ╚══════════#══════════════#════════K═══════╝
echo            _
echo   Ä
echo Ö
...
echo   XP lvl : %xpLVL%                         #            ╚══════════════╝
echo  ╔═══#══════════════#═════════#═════════════╗
echo  ║ Go outside [1] C#st : 15 EnerÄy    Ä     ║
echo  ║ Go Sleep [2] Re-ills Energy              ║                                #
echo  ║ SÜve#Game [3]                            ║
echo  ║ M_p [4]              Ä                   ║
echo  ║ Create B-ckup [5]         #              ║
...
echo  ║  [%pst%] P#stol [%pst%]               #          ║
echo  ║  [%shg%] Shotgun #%shg%]                         ║
echo  ║  [%spr%] SnÖ#er [%spr%]         ä                ║              #
echo  ║  [%fltr%] flSmetÜrow#r [%fltr%]                    ║
echo  ║  [%gel%] gre#adÖ lau#cher [%gel%]                ║
echo  ║  [%mgn%- Magnum [%mgn%]                     #    ║
echo  ║ #[%rtl%] R#ckeK La%n#heL [%rtl%]                 ║
echo  ╚══════════#═══════D══════#════════K═══════╝
echo            _   #
echo   Ä    #
echo Ö          G
...
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#═════════#═════════════╗ #
echo  ║ Go o#tside [1] C#st : 15#EnerÄy    Ä     ║
echo  ║ Go Sl#ep [2] Re-ills E#ergy              ║                                #
echo  ║ SÜve#Game [#]  #                         ║
echo  ║ M_p [4] #            Ä                   ║
echo  ║ Creat# B-ckup [5]         #              ║
echo  ║ Shops [%s#ps%/8 Founded] [6]                  ║
echo  ╠══════════════#═══════#════════-══════#═══╣
echo  ║ Weapo-+s                                  ║
echo  ║  [√] KnJfe [√]                           ║               #
echo  ║  [%pst%] P#stolä [%pst%]               #          ║
echo  ║  [%shg%] Shotg#n #%shg%]                         ║
echo  ║  [%spr%] SnÖ#er [%spr%]         ä                ║              #
echo  ║  [%fltr%] flS#etÜrow#r [%fltr%]                    ║
echo  ║  [%gel%#]gre#adÖ lau#cher [%gel%]                ║
echo  ║  [%mgn%- Magnum [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R##äeK La%n#heL [%rtl%]                 ║
echo  ╚═══ü══════#═══════D══════#═══#════K═══════╝
echo            _   # Ö
echo   ÄÄ    #
echo Ö      -    G
...
cls
echo ═══#══#════╦══Ä══════════ü════#═══════#══Ü══════════#═╦═══#═════════#═╦#═══════════-═════╦═══════════#╦════════════════
echo. HÜ : %hp%    #P : [%xpBar%] %xp%/1#0#   Hunger : %hunger%Ö   Thirst : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════#═══════╩═══════ä════Ä══╦#══════════════╦════════#═════#═══╩═══════#════╩════════════════
echo                                                       ║Ene#gy : %egy%  ║
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#══#══════#═════════════╗ #
echo  ║ Go o#tside [1] C#st : 15#EnerÄy    Ä     ║#
echo  ║ G_ Sä#ep [2] Re-ills E#ergy              ║                 #               #
echo  ║ SÜve#Game [#]  #                         ║#
echo  ║ M_p [4] #            Ä                   ║
echo  ║ Cr-at# B-ckup#[5]         #              ║
echo  ║ Shops [%s#ps%/8 Founded] [6]                  ║#
...
echo  ║  [%pst%] P#stolä [%pst%]               #          ║
echo  ║  [%shg%] Shotg#n #%shg%]                         ║
echo  ║  [%spr%] SäÖ#er [%spr%]         ä                ║        #      #
echo  #  [%fltr%] flS#etÜrow#r [%fltr%]                    ║
echo  ║  [%gel%#]gre#adÖ l-u#cher [%gel%]                ║
echo  ║  [%mgn%- Magnum [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R##äeK La%n#heL [%rtl%]   #             ║ #
echo  ╚═══ü══════#═══════D═-════#═══#════K═══════╝
echo            _   # Ö
...
cls
echo ═══#══#════╦══Ä══════════ü════#═══════#══Ü══════════#═╦═══#═════════#═╦#═══════════-═════╦═══════════#╦════════════════
echo. PÜ : %hp%    #P : [%xpBar%] %xp%/1#0#   Hunger : %hunger%Ö   Thirst : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════#═══════╩═══════ä════Ä══╦#══════════════╦════════#═════#═══╩═══════#════╩════════════════
echo                                                       ║Ene#gy : %egy%  ║
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#══#══════#══════S══════╗ #
...
cls
echo ═══#══#════╦══Ä══════════ü════#Ä══════#══Ü═-════════#═:═══#═════════#═╦#═══════════-═════╦═══════════#╦════════════════
echo. PÜ : %hp%  Ä #P : [%xpBar%] %xp%/1#0#   Hunger : %hunger%Ö   T#Ärst : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════#═══════╩═══════ä════Ä══╦#══════════════╦════#═══#═════#═══╩═══════#════╩════════════════
echo                                                       ║Ene#gy : %random%  ║
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#══#═══#══#══════S══════╗ #
echo  ║ Go o#tsölde [1] C#st : 15#Ene#Äy    Ä     ║#
echo  ║ G_ Sä#ep [2] Re-i#ls E#ergy              ║             #    #               #
echo  ║ SÜve#Game [##  #     '                    ║##
echo  ║ M_C [4] #          # Ä                   ║#
echo  ║ Cr-at# B-ck#p#[5]         #              ║
echo  ║ S#ops [%s#ps%/8 Foudded] [6]                 # ║#
echo  ╠══════════════#═══════#════════-════#═#═══╣
echo  ║ WeaSo-+s          ä      #                ║
echo  ║  [X] -nJfe [√]                 #         ║         #   #   #
echo  ║  [%pst%] P#stolä [%pst%]               #          ║
echo  ║  [%random%] Shotg#n #%shg%]                         ║
echo  ║  [%spr%] SäÖ#er [%spr%]         ä                ║      #  #        #   #
echo  #  [%fltr%] flS#etÜrow#r [%random%]                    ║#
echo  ║  [%gel%#]gre#adÖ l-u#cher [%random%]                ║
echo  ║  [%random%- Magnum [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R##äeK La%n#heL [%rtl%]   #             ║ #       #
echo  ╚═══ü══════#═══════D═-════#═══#════K═══════╝
echo            _   # Ö
echo   ÄÄ    #
...
cls
echo ═══#══#════╦══Ä══════════ü════#Ä══════#══Ü═-#═══════w#═:═══#═════════#═╦#═══════════-═════╦═══════════#╦════════════════
echo. PÜ : %hp%  Ä #P : [%xpBar%] %xp%/1#0#g   Hunger : %hunger%Ö   T#Ä#st : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════#═══════#═══════ä════Ä══╦#══════════════╦════#═══#═#═══#═══╩══w═════#════╩════════════════
echo                            g                           ║Ene#gy : %random%  ║
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#══#═══#══#══════S══════╗ #wö
echo  ║ Go o#tsölde [1] C#st : 15#Ene#Äy    Ä     ║#
echo  f G_ Sä#ep [2] Re-i#ls E#ergy              ║       fg  hw    #    #               #
echo  ║ SÜve#Game [##  #     '               #    ║##
echo  ║ M_C [#] #          # Ä             g      ║#ä
echo  ║ Cr-at# B-ck#p#[5] #       #              ║
echo  ║ S#op# [%s#ps%/8 Foudded] [6]                 # ║#
echo  ╠══════════════#═══════#════════-════#═#═══╣
echo  ║ WeaSo-+s          ä  #   #                ║d
echo  ║  [X] -nJfe [√]                 #     #   ║         #   # e  #
echo  ║  [%pst%] P#s#olä [%pst%]         #     #          n║
echo  ║  [%random%] S#otg#n #%shg%]    #       f      s       ║
echo  ║  [%spr%] SäÖ#er [%spr%]   #     ä                ║      #  d#        #   #r
echo  #  [%fltr%] flS#etÜrow#r [%random%]       #            ║#
echo  ║  [%gel%#]gre#adÖ l-u#cher [%random%]                ║h
echo  ║  [%random%- Magnum [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R##äeK La%n#heL [%rtl%]   #             ║ #       #
echo  ╚═══ü══════#═══════D═-════#═══#════K════#══╝
echo            _   # Ös
...
cls
echo ═══#══#════╦══Ä══════════ü════#Ä══════#══Ü═-#═# #  #      ══════w#═:═══#═════════#═╦#═══════════-═════╦═══════════#╦════
echo. PÜ : %hp%  Ä #P : [%xpBar%]  T#Ä#st : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#════════#═════════#═══════#═══════ä════Ä══╦#══════════════╦════#═══#═#═══#═══╩══w═════#════╩════════════════
echo                            g                           ║Ene#gy : %random%  ║
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═══#═══════#══════#══#═══#══#══════S══════╗ #wö
...
echo  #  [%fltr%] flS#etÜrow#r [%random%]       #            ║#
echo  ║  [%gel%        #]gre#adÖ l-u#cher [%random%]                ║h
echo  ║  [%random%- M     agnum [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R##äeK La%n#h       eL [%rtl%]   #             ║ #       #
echo  ╚═══ü══════#═══════D═-════#═══#════K════#══╝
echo            _   # Ös
echo   ÄÄ    #f
echo Ö              -    Gf
...
echo   XP #vl : %xpLVL%              ä          #            ╚══════════════╝
echo  ╔═         ══#═══════#══════#══ #═══#══#═ ══ ═══S══════╗ #wö
echo  ║    Go o#tsölde [1] C#s            t :  15#Ene#Äy    Ä     ║#
echo  f               G_ Sä#ep [2] Re-i#ls E#ergy              ║       fg  h      w    #    #               #
echo  ║ SÜve#Game [# #  #     '               #    ║##
echo  ║ M_C    [#] #          # Ä                   g      ║#ä  
echo  ║ Cr-a       t# B-ck#p# [5] #       #              ║
echo  ║ S#op#       [%s#ps%/8 Foudded] [6]                 # ║#
echo  ╠══════════════#═════     ══#═══ ═════-═ ═══#═#═══╣
echo  ║                                    We  aSo-+s          ä  #   #                ║d
echo  ║  [X] -nJ      fe [√]                  #     #   ║         #   # e  #
...
cls
echo ═══#══#s╦══Ä════ ═══# Ä══════#══Ü═-#═# #  #      ══════w#═:═══#═════════#═╦#═══════════-═════╦═══════════#╦
echo. aÜ : %hp%  Ä ## # # # d P : [%xpBar%]  T#Ä# st : %thst%%%   Name : %name% #   Money : %money%$    Day : %day%
echo ═══════════#Ö═══════#═════════#═══════#═══════ ä═══ ═Ä══╦#══════════╦════#═══#═#═══#═══╩══w═════#════╩════════════
echo                            g                            ║Ene#gy : %random%  ║
echo   XP #vl : #######              ä          #            ╚══════════════╝
echo  ╔═         ══#═══════#══════#══ #═══#══#═ ══ ═══S══════╗ #wö
echo  ║    wo o#tsölde # # # #s            t :  15#Ene#Äy    Ä     ║#
echo  f               G_ Sä#ep [2] Re-i#ls E#ergy              ║       fg  h      w    #    #               #
echo  ║ SÜve#GaPe [# #  #     '               #    ║##
echo  ║ M_C    [#] #          # Ä                   g      ║#ä  
echo  ║ Cr-a       t# B-ck##  # #      #              ║
...
echo  ║  [X] -nJ      fe [√]                  #     #   ║         #   # e  #
echo  ║  [%pst%] P#s#olä [%pst%]         #     #          n║
echo  ║  [fg    %random%] S#         otg    #n #%shg%]    #       f      s       ║
echo  ║  [%spr%S SäÖ#er [%spr%]   #     ä                ║      #  d#        #   #r
echo  #  [%fltr%] flS       #etÜrow#r [%random%]       #            ║#
echo  ║  [%gel%        #]gre#adÖ l-u#cher [      %random%]                ║h
echo  ║  [%random%- M     ag        num [%mgn%]  ä#                 #    ║
echo  ║ #[%rtl%] R#      #äeK La%n#h       eL [%rtl%]   #             ║ #       #
...
echo  ║  [%#####S SäÖ#er [%###║                                         ║        #   #r
echo  #  [#####] flS       #et╚═════════════════════════════════════════╝     #            ║#
echo  ║  [%#        #]gre#adÖ l-u#cher [      %r###]                ║h
echo  ║  [#%- M     ag        num [%mgn%]  ä#                 #    ║
echo  ║ #[%r#] R#      #äeK La%n#h       eL [#%]   #             ║ #       #
echo  ╚═══ü══════#═══════D═-════#═══#════K════#══╝
echo            _   # Ös
echo   ÄÄ    #f
echo Ö              -    Gf
...
echo   XP #vl : #######              ä          #            ╚══════════════╝
echo  ╔═         ══#═══#═══#═══e══#══ #═══#══#═ ══ ═══S══════╗ #wö
echo  ║    do o#tsölde # # # #s            t :  15#Ene#Äy    Ä     ║#
echo  f               G_ Sä#ep [2] Re-i#ls E#ergy              ║       fg  h      w    #    #               #
echo  ║ SÜve#eaPe [# #  #     '               #    ║##
echo  ║ M_C    [#] #          ╔═════════════════════════════════════════╗
echo  ║ Cr-a       t# B-ck##  ║              FATAL ERROR                ║#
...
echo  ║                      #║             Restarting                  ║        #       ║d
echo  ║  [X] -nJ      fe [√]  ║             [████████]                  ║        #
echo  ║ ####] P#s#olä [%###]  ║           DONT START REPAIR.exe         ║
echo  ║  [fg    #######] S#   ║               ...                       ║    #  ║
echo  ║  [%#####S S#Ö#er [%###║                                         ║        #   #r
echo  #  [#####] fl#       #et╚═════════════════════════════════════════╝     #            ║#
echo  ║  [%#        #]gre#adÖ l-u#cher [  #    %r###]                ║h
...
color 27
cls
echo EvilSystems Evilux [SovietOS] [Version 10.0.22000.613]
echo (c) Soviet Union. Alle Rechte vorbehalten.
...
:menu1
set /p a=
if %a% EQU help goto help1
if %a% EQU ls goto ls
if %a% EQU run goto run
goto menu1

:help1
echo.
echo Command List :
echo ls [Shows files in a folder]
echo run [runs files]
goto menu1
...
:run
set /p a=File : 
if %a% EQU REPAIR.exe goto rep 
echo "%a%" 404 ERROR [File Not Found]
goto menu1
...
echo.
ping localhost -n 2 > NUL
echo Happy-Birthday Script Stopped, Press a Button to play the actual Game
pause > NUL
goto menu
